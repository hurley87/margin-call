...
/**
 * Pricing availability for one launch asset: `?asset=NVDAc` or `?assetId=1`.
 *
 * Answers whether Margin Call will finance an open right now, without naming
 * the oracle state that produced the answer.
 */
