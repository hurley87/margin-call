...
- Vault share pricing reflects a verified result immediately at finalization or expiry, so a publicly known outcome cannot be traded against remaining LPs.
