...
Mainnet amendment (ADR-0006): the fee bounds a farmer's cost, not their share of the distribution — under a tradable token the ungated pot becomes a continuous token sale at fee cost. Mainnet therefore identity-gates Participation Reward claims while play stays permissionless; this ADR governs the testnet Season as written.
