...
[Transferable Financed Spot Positions PRD](margin-account-prd.md) is the current proposed product direction. It supersedes the standalone Stock Gacha MVP and generalized inventory-protocol proposals as active requirements.
...
The PRD defines behavior and acceptance criteria. The glossary defines terms. ADRs explain consequential trade-offs; they do not assert that the proposed product has shipped.
