...
- **`contracts/`** — Foundry workspace (MockUSD + PackCustody today; Pack economy contracts next). See `contracts/README.md` and `contracts/REPRODUCIBILITY.md`.
...
- **Contracts:** Foundry CI on every PR; MockUSD is the protocol mock stablecoin for Robinhood Chain testnet.
