...
contract DeployMarginCallCrashHarness is DeployMarginCallCrash {
        ...
        returns (Deployment memory deployment)
    {
        ...
        deployment = _deploy(broadcaster, epochOrigin);
        vm.stopBroadcast();
    }
}
...
contract DeployMarginCallCrashTest is Test {
    ...
    function testDeploysCrashGameOnMinuteAlignedEpoch() public {
    ...
    function _existingDeployment() internal pure returns (DeployMarginCallCrash.ExistingDeployment memory) {
        return DeployMarginCallCrash.ExistingDeployment({chainId: BASE_SEPOLIA_CHAIN_ID, deployer: DEPLOYER});
    }
}
