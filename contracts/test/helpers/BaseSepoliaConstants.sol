...
///      Note: active escrow/SeatVault are the #211 hardened redeploy (Gate 2).
library BaseSepoliaConstants {
    uint256 internal constant CHAIN_ID = 84532;

    /// @dev Base Sepolia tip around 2026-07-14, after #211 Gate 2 escrow/SeatVault
    ///      activation (`base-sepolia.active.json` deployedAt 2026-07-14).
    uint256 internal constant BLOCK_NUMBER = 44_112_000;

    address internal constant ESCROW = 0x9A7Ca01E00be0717d28509E1fdC2a8543dE86D03;
    address internal constant MARGINCALL_TOKEN = 0x0d93099c1b24C848e7A7DD77c5a50de0735A60d7;
    address internal constant SEAT_VAULT = 0xA901DFC8C46faF3A24F4002849dE98dFE9722C95;
