...
contract FinancedDebtTest is MarginCallTestBase {
    function test_currentDebtGrowsOverTimeWithoutKeeper() public {
        ...
        uint256 accruedAfterWarp = _position(tokenId).accruedInterest;
    ...
    function test_timeBoundaryRoundingAndRepeatedCheckpoint() public {
        ...
        uint256 pFinal = pos.principal;
        uint256 aFinal = pos.accruedInterest;
        assertEq(pFinal, 0);
        assertEq(aFinal, 0);
    }
    ...
    function test_repeatedDustCheckpointsCannotEraseDebtBeyondPayment() public {
        ...
        uint256 principal = _position(idle).principal;
        ...
        MarginCall.Position memory pos = _position(churned);
        uint256 churnedPrincipal = pos.principal;
        uint256 churnedAccrued = pos.accruedInterest;
